...
const TableThree = ({ userData }: { userData: Array<Item> }) => {
          ...
          <tbody>
            {userData.map((packageItem, key) => (
              <tr key={key}>
                ...
                <td>
                  <p className="inline-flex rounded-full bg-opacity-10 px-7 py-1 text-sm font-medium">
                    {packageItem.tokenbalance}
                  </p>
                </td>
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
